cask "nodespace" do
  ...
  # v0.2.0 ships an Apple Silicon build only — the release stopped publishing
  # an Intel (x64) .dmg. See NodeSpaceAI/nodespace-core#2114 for the tap-drift
  # fix and NodeSpaceAI/nodespace-core#2154 for tracking the missing Intel build.
